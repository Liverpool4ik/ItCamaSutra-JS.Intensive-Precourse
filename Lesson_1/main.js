...
const FootballLeagues = {
	...
	clubs: ["Liverpool", "Arsenal", "Manchester United", "Chelsea", "Man City"],
};
...
premierLeagueClubSelect0.append(FootballLeagues.clubs[0]);

let premierLeagueClubSelect1 = document.createElement("option");
premierLeagueClubSelect1.append(FootballLeagues.clubs[1]);

let premierLeagueClubSelect2 = document.createElement("option");
premierLeagueClubSelect2.append(FootballLeagues.clubs[2]);

let premierLeagueClubSelect3 = document.createElement("option");
premierLeagueClubSelect3.append(FootballLeagues.clubs[3]);

let premierLeagueClubSelect4 = document.createElement("option");
premierLeagueClubSelect4.append(FootballLeagues.clubs[4]);
